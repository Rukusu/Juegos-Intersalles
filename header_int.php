...
<header class="interior">
			<div class="wrapper">
				<a href="./" id="juegos"></a>
				<label id="menu_int" for="chkMenu"></label>
				<nav>
					<a href="bienvenida.php">Bienvenida y Programa</a>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-136763814-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-136763814-2');
</script>
